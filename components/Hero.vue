<template>
  <div class="relative bg-heroBg bg-cover bg-center">
    <div class="container mx-auto">
      ...
      />
      <img
        class="absolute top-0 right-20 h-1/2"
      ...
      <div class="px-4 py-12 md:mt-12 md:p-24 flex items-center">
        <div>
          ...
          <a
            href="#"
            class="block bg-[#288E7E] py-3 text-white px-5 rounded-3xl md:border-0 w-fit mt-16"
        ...
        <div class="hidden md:flex items-center relative">
          ...
          />
          <img
            class="absolute bottom-20 right-40 h-20"
            src="../assets/images/bubble.png"
            alt=""
          />
          <img
            class="absolute bottom-0 left-40"
